...
from wagtail.admin.rich_text.converters.html_to_contentstate import HtmlToContentStateHandler, BLOCK_KEY_NAME
...
def persist_key_for_block(config):
    ...
    def element_with_uuid(props):
        ...
        try:
            ...
            addedProps.update(element_props)
            return DOM.create_element(element, addedProps, props['children'])
